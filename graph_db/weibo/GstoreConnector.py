...
class GstoreConnector:
    ...
    def query(self, username, password, db_name, sparql):
        cmd = self.Url + "/?operation=query&username=" + username + "&password=" + password + "&db_name=" + db_name + "&format=json&sparql=" + sparql.replace('\t', ' ')
        return self.Get(cmd)
    ...
    def drop(self, username, password, db_name):
        cmd = self.Url + "/?operation=drop&db_name=" + db_name + "&username=" + username + "&password=" + password
        return self.Get(cmd)